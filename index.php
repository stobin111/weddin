...
<html>
	...
	<body class="landing">
		...
		})(window,document,'script','dataLayer','GTM-5NF6MV');</script>
			...
			<div id="page-wrapper">
				...
				<!-- One -->
					 <section id="one" class="wrapper style1 special">
						<div class="inner">
							<header class="major">
							  <img class="hitched" src="images/hitched.png" alt="">
							...
							<ul class="icons major">
								...
								<li><span class="icon fa-calendar major style3"><span class="label">Dolor</span></span></li>
							</ul>
						</div>
					</section>
					...
					<section id="cta" class="wrapper style4">
						<div class="inner">
							<header>
								...
								<a href="tel:+651-647-1637">651-647-1637</a><br />
							...
							<ul class="actions vertical">
							  <li><a href="deets" class="button fit special">More Info</a></li>
								<li><a href="things" class="button fit">Things to do</a></li>
							</ul>
						</div>
					</section>
					...
					<section id="rsvp" class="wrapper style4">
                      ...
                      <div class="newGuest row uniform">
                        ...
                        <div class="4u 12u$(small)">
                        	...
                        	<label for="demo-priority-low">Chicken</label>
                        </div>
                        <div class="4u 12u$(small)">
                        	<input type="radio" id="demo-priority-normal" name="demo-priority">
                        	<label for="demo-priority-normal">Fish</label>
                        </div>
                        <div class="4u$ 12u$(small)">
